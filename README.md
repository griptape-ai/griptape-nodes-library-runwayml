...
| `duration`           | `int`                   | Duration of the output video in seconds (2-10). Billed per second.                                                                                                           | `10`          |
| `seed`               | `int`                   | Seed for reproducible generation. Use `seed_control` to vary it between runs.                                                                                                | `12345`       |
| `seed_control`       | `str`                   | How the seed changes between runs: `fixed`, `increment`, `decrement`, `randomize`.                                                                                           | `randomize`   |
| `content_moderation` | `str`                   | Content moderation level. `low` is less strict about public figures.                                                                                                         | `auto`        |
| `output_format`      | `str`                   | Delivery container, `gen4.5` only. See **Professional output formats**.                                                                                                      | `mp4`         |
| `prores_profile`     | `str`                   | ProRes tier, used only when `output_format` is a ProRes container.                                                                                                           | `4444`        |
...
| `seed_control`       | `str`                  | How the seed changes between runs: `fixed`, `increment`, `decrement`, `randomize`.                                            | `randomize`   |
| `content_moderation` | `str`                  | Content moderation level. `low` is less strict about public figures.                                                          | `auto`        |
| `image_output`       | `ImageUrlArtifact`     | **Output:** The generated image, saved into project files.                                                                    | `None`        |
| `task_id_output`     | `str`                  | **Output:** The Task ID of the generation job from RunwayML.                                                                  | `None`        |
...
| `seed_control`            | `str`                                        | How the seed changes between runs: `fixed`, `increment`, `decrement`, `randomize`.                                                                                                   | `randomize`   |
| `output_format`           | `str`                                        | Delivery container. See **Professional output formats**.                                                                                                                             | `mp4`         |
| `prores_profile`          | `str`                                        | ProRes tier, used only when `output_format` is `prores`.                                                                                                                             | `4444`        |
| `video_output`            | `VideoUrlArtifact`                           | **Output:** The generated video, saved into project files.                                                                                                                           | `None`        |
| `task_id_output`          | `str`                                        | **Output:** The Task ID of the generation job from RunwayML.                                                                                                                         | `None`        |
